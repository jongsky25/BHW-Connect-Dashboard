...
describe("the UUC for PHC entries (plan U5)", () => {
  ...
  it("registers all ten objects, approved and public", () => {
    // Four from U5, plus agg_uuc_phc_criteria from U7, agg_uuc_phc_indicator_dist from U9,
    // U10's three data-quality relations and U11's ref_uuc_phc_list. A new relation the registry
