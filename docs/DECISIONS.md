...
publishes 5,987.** Migration `20260828120000_uuc_phc_final_list_alignment.sql`; registry delta
`20260828120100_seed_registry_final_list_alignment.sql`; full reasoning in
