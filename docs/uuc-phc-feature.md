...
- **The rows are downloadable, with the marker in a column** (U11). `/api/export/uuc-phc/data`
  ...
  "Downloads" below.
- **Not built yet:** the `/explore` overlay. Planned as U12 in `docs/UUC_PHC_2025_PLAN.md` §9.
...
3. Re-run the aggregate blocks of `20260826140000_agg_uuc_phc_counts.sql`,
   ...
   `20260827170000_uuc_phc_data_quality.sql` and `20260827180000_ref_uuc_phc_list.sql`, in that
   order. All five recompute from the fact tables, so they need no regeneration — only
