...
import { getNhfrCounts, getNhfrChildren, getNhfrTypes } from "@/lib/db/nhfr";
    ...
    <div className="flex flex-col gap-8">
      <section className="flex flex-col gap-3">
        ...
        <p className="max-w-2xl text-muted">
          ...
          <strong>National Health Facility Registry</strong> — every hospital, rural health unit,
          barangay health station, clinic and laboratory it registers, with the barangay each one
          sits in. This is the September 2026 snapshot, shown alongside the BHW workforce that
          staffs much of it.
        </p>
      </section>
      ...
      <section className="rounded-lg border border-border bg-background p-5 sm:p-6">
        ...
        <div className="mt-6 border-t border-border pt-5">
          ...
          <p className="mt-3 text-xs text-muted">
            {formatCount(withoutFacility)} barangays have no registered health facility at all.
          </p>
        </div>
      </section>
